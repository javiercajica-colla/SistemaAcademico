            ...
            const AppCard(
              child: Center(
                child: Padding(
                  ...
                  child: Text('No tienes hijos registrados'),
                ),
              ),
            )
          else ...[
              ...
              children: [
                Expanded(
                  child: _infoBox(
                    ...
                    attPct >= 80 ? AppColors.secondary : AppColors.warning,
                ...
                Expanded(
                  child: _infoBox(
                    'Inasistencias',
                    '$absents',
                    absents == 0 ? AppColors.secondary : AppColors.error,
                ...
                Expanded(
                  child: _infoBox(
                    'Observaciones',
                    '${obs.length}',
                    obs.isEmpty ? AppColors.secondary : AppColors.warning,
              ...
              children: notifs.map((n) {
                ...
                switch (n.type) {
                  case NotificationType.grade:
                    c = AppColors.primary;
                    ic = Icons.grade_rounded;
                  case NotificationType.attendance:
                    c = AppColors.warning;
                    ic = Icons.event_busy_rounded;
                  case NotificationType.observation:
                    c = AppColors.purple;
                    ic = Icons.edit_note_rounded;
                  case NotificationType.report:
                    c = AppColors.secondary;
                    ic = Icons.summarize_rounded;
                  default:
                    c = AppColors.info;
                    ic = Icons.notifications_rounded;
                }
                return Padding(
