...
class StudentAttendanceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final absent = allAttendance
        ...
        .length;
    final late = allAttendance
        .where((a) => a.status == AttendanceStatus.late)
        .length;
    final excused = allAttendance
        .where((a) => a.status == AttendanceStatus.excused)
        .length;
    final pct = allAttendance.isNotEmpty
        ? (present / allAttendance.length * 100)
        : 100.0;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const SectionHeader(
            title: 'Mi Asistencia',
            subtitle: 'Historial de asistencia por asignatura',
          ),
      ...
      children: [
        Container(
          ...
          child: Row(
            children: [
              Icon(
                pct >= 80 ? Icons.check_circle_rounded : Icons.warning_rounded,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      '${pct.toStringAsFixed(1)}% de asistencia',
                      style: TextStyle(
                    ...
                    Text(
                      pct >= 80
                          ? 'Tu asistencia está en buen nivel'
